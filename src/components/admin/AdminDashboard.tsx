...
const getPlatformColor = (plateforme: string) => {
  const colors: Record<string, string> = {
    Netflix: "#e50914", "Prime Video": "#00a8e1", Spotify: "#1db954", GogoFlix: "#f5a623", Disney: "#113ccf", "Disney+": "#113ccf",
  };
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <select value={plateforme} onChange={(e) => setPlateforme(e.target.value)} className="form-control" style={inputStyle}>
                {["Netflix", "Prime Video", "Spotify", "GogoFlix", "Disney+","Pack"].map((p) => <option key={p} value={p}>{p}</option>)}
              </select>
            </div>
        ...
        <div style={formCardStyle}>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <label style={labelStyle}>Plateforme *</label>
              <select value={plateforme} onChange={(e) => setPlateforme(e.target.value)} className="form-control" style={inputStyle}>
                {["Netflix", "Prime Video", "Spotify", "GogoFlix", "Disney+"].map((p) => <option key={p} value={p}>{p}</option>)}
              </select>
            </div>
